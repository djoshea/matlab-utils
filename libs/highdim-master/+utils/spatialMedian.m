function y = spatialMedian(X,tol,y,max_iter)
% Calculate the geometric median for a set of observations (mean under a 
% Laplacian noise distribution) This is using Weiszfeld's algorithm.
%
% In:
...
% https://github.com/sccn/BCILAB/code/misc/geometric_median.m
